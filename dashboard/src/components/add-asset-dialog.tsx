...
import { createAsset, type AssetCreate } from "@/lib/api";
...
export function AddAssetDialog({ onAssetAdded }: AddAssetDialogProps) {
  ...
  const updateField = <K extends keyof AssetCreate>(key: K, value: AssetCreate[K]) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setForm({ hostname: "", ip_address: "", os_family: "", os_version: "", environment: "production", criticality: "medium" });
      setOpen(false);
      onAssetAdded();
    } catch (err) {
